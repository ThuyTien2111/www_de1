...
<div class="container">
    ...
    <table class="table">
        ...
        <%
            ...
            List<ServicePriceDTO> services=svcPriceService.getServicePriceNotHave(apptNo);
            //Phân trang
        ...
        <tr>
            ...
            <td><%=s.getPrice()%></td>
            <td>
                <a href="invoiceControl?action=addInvoiceByAppt&svcID=<%=s.getSvcID()%>&apptNo=<%=apptNo%>" class="btn btn-success">Đặt lịch</a>
            </td>
        </tr>
        <%
            }
    ...
    <ul class="pagination">
        ...
        <li class="page-item <%= i == currentPage ? "active" : "" %>">
            <a class="page-link" href="invoiceControl?action=addSvcToAppt&apptNo=<%=apptNo%>&page=<%= i %>"><%= i %></a>
        </li>
        <%
            }
        %>
